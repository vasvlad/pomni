...
def create_configuration_ui(main_switcher):
    ...
    toplevel_table = gtk.Table(rows=1, columns=2)
    toolbar_container = create_toolbar_container( \
    ...
    menu_button = create_button('config_toolbar_main_menu_button', None)
    ...
    font_size_decrease_button = create_button( \
        'config_mode_decrease_font_size_buttton', None, width=64, height=64)
    font_size_increase_button = create_button( \
        'config_mode_increase_font_size_buttton', None, width=64, height=64)
    ...
    tts_lang_container = create_button('config_mode_tts_lang_container', \
        width=-1, height=60)
    tts_lang_label = gtk.Label('default')
    tts_lang_label.set_name('config_mode_tts_lang_label')
    tts_lang_prev_button = create_button('config_mode_tts_lang_prev_button', \
        None)
    tts_lang_next_button = create_button('config_mode_tts_lang_next_button', \
        None)
    tts_voice_table = gtk.Table(rows=1, columns=3)
    tts_voice_container = create_button('config_mode_tts_voice_container', \
        width=-1, height=60)
    tts_voice_label = gtk.Label('Male')
    tts_voice_label.set_name('config_mode_tts_voice_label')
    tts_voice_prev_button = create_button('config_mode_tts_voice_prev_button', \
        None)
    tts_voice_next_button = create_button('config_mode_tts_voice_next_button', \
        None)
...
def create_about_ui(main_switcher, image_name):
    ...
    menu_button = gtk.Button()
    menu_button.set_size_request(80, 80)
    menu_button.set_name('about_toolbar_main_menu_button')
