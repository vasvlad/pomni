...
<<<<<<< HEAD:mnemosyne/mnemosyne/pomni/hildon_configure.py
...
=======
        ...
        self.config_mode_label_theme.set_text("Current theme: " + \
            theme.capitalize())
        self.config_mode_entry_imagedir.set_text(config()['imagedir'])
>>>>>>> upstream_sync:mnemosyne.moved/mnemosyne/pomni/debian/pomni/usr/lib/python2.5/site-packages/pomni/hildon_configure.py
