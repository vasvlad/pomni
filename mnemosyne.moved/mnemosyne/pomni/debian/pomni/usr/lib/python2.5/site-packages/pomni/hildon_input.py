...
<<<<<<< HEAD:mnemosyne/mnemosyne/pomni/hildon_input.py
...
=======
        ...
        self.init_listboxes()
>>>>>>> upstream_sync:mnemosyne.moved/mnemosyne/pomni/debian/pomni/usr/lib/python2.5/site-packages/pomni/hildon_input.py
        self.layout()
